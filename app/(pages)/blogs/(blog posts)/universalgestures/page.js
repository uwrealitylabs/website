            ...
            body={[
              <div key="1" className="max-w-full overflow-x-hidden">
                ...
                <ul key="6" className="list-disc pl-6 space-y-4">
                  <li>
                    It is technically challenging to configure, and requires the developer to have a solid technical understanding of what's happening under the hood.
                ...
                <p>
                  ...
                  By applying a variety of neural network architectures along with Unity Barracuda and ONNX Runtime,
                ...
                <p>
                  ...
                  loop can be run without ever having to exit Unity Play Mode. Additionally, once models are trained, they can be run
                ...
                <p>
                  ...
                  <br key="23" />
                  Before negative training examples are passed to the Flask server for training, we enrich them with synthetic data that covers a broad range of random hand poses.
                  We use a Python script that generates finger positions with enough "distance" to your positive examples, and then add
                  them to the negative data pool. This way, your model won't recognize false-positives regularly.
                </p>
                ...
                <p>
                  Once you have your trained model in .onnx format, it's straightforward to set up gesture detection. Simply drag in a prefab that
                  we've created, select your model, select a function to run when your gesture is detected, and configure 1-2 settings.
                ...
                <br key="30" />
                <ul key="31" className="list-disc pl-6 space-y-4">
                  <li>
                ...
                <br key="38" />
                <ol key="39" className="list-decimal pl-6 space-y-4">
                  <li>
                ...
                <br key="43" />
                <p>
                  For this use case, we opt to use LSTM (Long Short-Term Memory) neural networks as our architecture. LSTM models are recurrent neural networks useful for <em>sequence learning</em> :
                ...
                <br key="48" />
                <ul key="49" className="list-disc pl-6 space-y-4">
                  <li>
                ...
                <ul key="58" className="list-disc pl-6 space-y-4">
                  <li>
                ...
                <p>
                  ...
                  our applications open again soon. For organizations who wish to support our work,&nbsp;
