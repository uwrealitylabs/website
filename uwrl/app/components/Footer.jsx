...
export default function Footer() {
  ...
  return (
    ...
    <footer className=" w-full h-830 bg-cover bg-no-repeat bg-bottom bg-[url('/images/assets/city-footer.png')] bg-bck-grey flex max-2xl:justify-center">
      ...
      <div className="flex flex-col gap-12">
        <h1 className="font-neraphic text-h1 text-text-lightBody max-w-830
        ---1024px---
        max-lg:text-h2
